...
const descriptions = {
  ...
  'Flutter': 'Embark on a journey to master Flutter, developing cross-platform mobile apps with fluid UIs and rich user experiences using Dart programming and cutting-edge development techniques.',
